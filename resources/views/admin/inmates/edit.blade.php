    ...
    <div class="page-wrapper">
        ...
        <div class="row">
            <div class="col-xl-7 mx-auto">
                <h6 class="mb-0 text-uppercase">{{__('Inmate')}}</h6>
				<hr/>
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">{{__('Edit')}}</h5>
                        </div>
                        <hr>
                        <form class="row g-3" action="{{route('updatePrisonInmate', $inmateToEdit->id)}}" method="POST">
                            ...
                            <div class="col-md-6">
                                <label for="">{{__('Inmate Status')}}</label>
                            ...
                            <div class="col-12">
                                <label for="inputAddress" class="form-label">{{__("Raison")}}</label>
                                <textarea required name="reason" class="form-control" id="inputAddress" placeholder="Reason..." rows="3">
                                    {{$inmateToEdit->reason}}
                                </textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-success px-5">{{__('Update')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
